...
int FbxObj::GetSubMaterialIndex(int iPoly, FbxLayerElementMaterial* pMaterialSetList)
{
    int iSubMtrl = 0;
...
FbxVector4 FbxObj::ReadNormal(const FbxMesh* mesh, int controlPointIndex, int vertexCounter)
{
...
FbxColor FbxObj::ReadColor(const FbxMesh* mesh, DWORD dwVertexColorCount, FbxLayerElementVertexColor* pVertexColorSet, DWORD dwDCCIndex, DWORD dwVertexIndex)
{
